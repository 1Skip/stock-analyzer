...
def test_a_share_decision_builds_five_agent_views():
    ...
    extended = {
        "fund_flow": {"main_net_inflow": 12000000, "five_day_main_net_inflow": 33000000},
        "financial": {"metrics": {"营业总收入": 100000000, "归母净利润": 20000000}},
    ...
    result = build_a_share_decision(data, signals, {"price": 10.6, "change": 1.2}, extended)
