...
## ??????????? / ?????
- ?????????????????????????/????????????????????
- ???????? AKShare ?????? `stock_news_main_cx()`??????????`stock_news_em(symbol)` ????????????????????????????????????????? AKShare ????????
- ?????
  - `AkShareInfoProvider` ?? `get_market_news()` ? `_normalize_market_news()`????? payload ?? `market_news`?
  - Web ???????????????????????????????? `extended:v4:core/full`?
  - ?????????? / ????????????? / ?? / ???????????????
  - A???????????? `market_news`?????????????
- ???
  - `stock_news_main_cx()` ???? 100 ??????
  - ????????????UI ???????????????
...
- ?????? A ??????????? `C ???` ????????????????????????????????????
- ???? `C ???` ???????????????????? provider?????????/??????????
- ???`002066` ??????? `C ???` ???????`py -m pytest tests	est_data_services.py tests	est_ui_enhancements.py -q` ? 54 passed?


## ????????????????????
- ???????????????????????????????????????????????????????????????
- ????????????? `https://basic.10jqka.com.cn/{code}/company.html` ????????????????????????????????? `???????` ???????????
- ?????`002066` ???? ? `???? ? ????`?`000001` ???? ? `?? ? ??????`?`688981` ???? ? `?? ? ???`?`920496` ???? ? `???? ? ????`?
- ???`py -m pytest tests	est_data_services.py tests	est_ui_enhancements.py -q` ? 58 passed?
