...
- [Bug fixes & context 2026-07-12](bug_fixes_and_context_2026-07-12.md) — 个股分析新增只读量化快照与样本可信度；手工成交支持编辑；自选股、缓存、超时与关键 fallback 完成可观测性加固；推荐股票池辅助逻辑继续拆分；CI 新增默认断网、66.5% 跨平台覆盖率基线和高风险 Ruff 规则；完整测试 `983 passed`。
